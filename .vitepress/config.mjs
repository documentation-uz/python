...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {text: 'Tutorial', link: '/tutorial/table-of-contents'},
            ...
            '/docs/': [
                {
                    ...
                    items: [
                        ...
                        {text: 'Quick start', link: '/docs/get-started/quick-start'}
                    ]
                },
                {
                    text: 'Essentials',
                    items: [
                        {text: 'Syntax', link: '/docs/essentials/syntax'},
                        {text: 'Print', link: '/docs/essentials/print'},
                        {text: 'Comments', link: '/docs/essentials/comments'},
                        {text: 'Arithmetic operators', link: '/docs/essentials/arithmetic-operators'},
                        {text: 'Variables', link: '/docs/essentials/variables'},
                        {text: 'Data types', link: '/docs/essentials/data-types'},
                        {text: 'Change data type', link: '/docs/essentials/change-data-type'},
                        {text: 'Input', link: '/docs/essentials/input'},
                        {text: 'Logical operators', link: '/docs/essentials/logical-operators'},
                        {text: 'Comparison operators', link: '/docs/essentials/comparison-operators'},
                        {text: 'String', link: '/docs/essentials/string'},
                        {text: 'String methods', link: '/docs/essentials/string-methods'},
                        {text: 'List', link: '/docs/essentials/list'},
                        {text: 'List methods', link: '/docs/essentials/list-methods'},
                        {text: 'Tuple', link: '/docs/essentials/tuple'},
                        {text: 'Set', link: '/docs/essentials/set'},
                        {text: 'Dictionary', link: '/docs/essentials/dictionary'},
                        {text: 'Dictionary methods', link: '/docs/essentials/dictionary-methods'},
                        {text: 'If statement', link: '/docs/essentials/if-statement'},
                        {text: 'For loop', link: '/docs/essentials/for-loop'},
                        {text: 'While loop', link: '/docs/essentials/while-loop'},
                        {text: 'Function', link: '/docs/essentials/function'},
                        {text: '*args and **kwargs', link: '/docs/essentials/args-and-kwargs'},
                        {text: 'Lambda', link: '/docs/essentials/lambda'},
                        {text: 'Decorator', link: '/docs/essentials/decorator'},
                        {text: 'Introduction to OOP', link: '/docs/essentials/oop/introduction-to-oop'},
                        {text: 'Class', link: '/docs/essentials/oop/class.md'},
                        {text: 'Methods', link: '/docs/essentials/oop/methods.md'},
                        {text: 'Inheritance', link: '/docs/essentials/oop/inheritance.md'},
                        {text: 'super()', link: '/docs/essentials/oop/super.md'},
                        {text: 'Magic methods', link: '/docs/essentials/oop/magic-methods.md'},
                    ]
                },
            ],
            'tutorial': [
                {
                    text: 'Table of contents', link: '/tutorial/table-of-contents',
                },
                {
                    text: 'Project 1', collapsed: false,
                    items: [
                        {text: 'Step 1', link: '/tutorial/step-1'},
                    ]
                }
            ],
            '/api-reference/': [
                {
                    text: 'Built-in functions', collapsed: false,
                    items: [
